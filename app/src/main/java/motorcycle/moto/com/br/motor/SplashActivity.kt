package motorcycle.motor.com.br.motor
...
import motorcycle.motor.com.br.motor.api.UsuarioAPI
import motorcycle.motor.com.br.motor.model.Usuario
import kotlinx.android.synthetic.main.activity_login.*
//import motorcycle.moto.com.br.motor.R
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       if(s!!.getBoolean("validaLogin", false)){
           ...
           val api = RetrofitClient.getInstance("https://motorcycleapi.herokuapp.com").create(UsuarioAPI::class.java)
